    ...
    return (
        <div className="min-h-screen bg-[#0a0a0b] text-white p-4 md:p-24 flex flex-col items-center">
            <div className="max-w-4xl w-full">
                ...
                <div className="glass p-6 md:p-8 rounded-3xl mb-12 border-blue-500/20 bg-blue-500/5 relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-4">
                        <div className="px-2 md:px-3 py-0.5 md:py-1 bg-blue-500/20 rounded-full border border-blue-500/30 text-[8px] md:text-[10px] font-bold uppercase tracking-widest text-blue-400">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                    {statCards.map((card) => (
                        <div key={card.label} className="glass p-4 md:p-6 rounded-2xl flex flex-col items-center text-center">
                            <card.icon className={cn("w-5 h-5 md:w-6 md:h-6 mb-3 md:mb-4", card.color)} />
